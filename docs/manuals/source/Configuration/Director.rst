...
.. config:option:: dir/fileset/include/options/compression
   ...
   :type: <GZIP|GZIP1|...|GZIP9|LZO|LZFAST|LZ4|LZ4HC|ZSTD|ZSTD1|...|ZSTD9>
   ...
   ZSTD
        ...
        but the fastest algorithm, and :strong:`compression=ZSTD9`
        would give a higher level of compression at the cost of more CPU.
